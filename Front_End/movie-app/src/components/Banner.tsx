...
function Banner() {
  return (
    <div className="md:h-[600px] h-[1000px] w-full bg-[url(/public/banner.png)] bg-cover bg-center bg-no-repeat relative mt-[75px]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between absolute md:top-1/2 top-10 -translate-x-1/2 left-1/2 md:-translate-y-1/2 w-full ">
        <div className="md:w-[50%] w-full ">
          <div className="flex flex-col space-y-6 items-start p-10">
            <p className="bg-linear-to-r from-red-600 to-red-300 py-2 px-6">
              TV Show
            </p>
